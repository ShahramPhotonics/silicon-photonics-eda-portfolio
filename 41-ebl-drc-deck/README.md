...
GitHub repository: `41-ebl-drc-deck`
## Process / materials
- Technology: EBL microfabrication verification
- Materials: Silicon photonic nanofabrication constraints
- Device parameters: Min width 50 nm, gap 60 nm, acute angles, enclosure
- Frameworks: KLayout .drc Python/Ruby deck
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/41-ebl-drc-deck
