...
GitHub repository: `46-heater-erc`
## Process / materials
- Technology: Thermo-optic circuit verification
- Materials: TiN / aluminum heater layers
- Device parameters: Opens, metal-WG clearance, current-density width
- Frameworks: KLayout ERC script
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/46-heater-erc
