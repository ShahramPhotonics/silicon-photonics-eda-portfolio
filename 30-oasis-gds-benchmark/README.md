...
GitHub repository: `30-oasis-gds-benchmark`
## Process / materials
- Technology: Tape-out data optimization
- Materials: Large-scale PIC layouts (>1e8 polygons)
- Device parameters: C-shaped repetition, size and load-time log
- Frameworks: Conversion pipeline + CSV benchmark
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/30-oasis-gds-benchmark
