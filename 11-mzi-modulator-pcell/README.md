...
GitHub repository: `11-mzi-modulator-pcell`
## Process / materials
- Technology: Silicon photonic modulators
- Materials: Si 220 nm, PN junctions, Al metal lines
- Device parameters: Arm length, doping layers, contact pads
- Frameworks: klayout.db PCellDeclarationHelper
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/11-mzi-modulator-pcell
