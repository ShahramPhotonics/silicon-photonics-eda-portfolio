...
GitHub repository: `14-swg-edge-coupler-pcell`
## Process / materials
- Technology: Edge coupling / packaging
- Materials: Oxide-overclad Si taper + SiN overlay
- Device parameters: Spot-size conversion to 10.5 um MFD fiber
- Frameworks: Inverse taper + SWG pitch PCell
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/14-swg-edge-coupler-pcell
