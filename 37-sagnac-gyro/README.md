...
GitHub repository: `37-sagnac-gyro`
## Process / materials
- Technology: Optical sensing
- Materials: Ultra-low loss Si3N4 <0.1 dB/cm
- Device parameters: 2 m path packed into 10 mm^2 multi-pass spiral
- Frameworks: Archimedean / multi-pass spiral
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/37-sagnac-gyro
