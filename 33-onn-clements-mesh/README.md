...
GitHub repository: `33-onn-clements-mesh`
## Process / materials
- Technology: Neuromorphic photonics
- Materials: High-speed Si modulators, metal phase shifters
- Device parameters: 4x4 weight matrix, SVD, Clements MZI mesh
- Frameworks: Linear-algebra-driven layout
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/33-onn-clements-mesh
