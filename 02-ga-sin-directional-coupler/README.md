...
GitHub repository: `02-ga-sin-directional-coupler`
## Process / materials
- Technology: SiN Photonics (300 nm silicon nitride)
- Materials: Si3N4 core n=2.000, SiO2 clad n=1.444 @ 1550 nm
- Device parameters: L=5-40 um, gap=200-600 nm, taper=300-900 nm, split 50:50 to 90:10
- Frameworks: NumPy GA + klayout.db PCell instantiation
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/02-ga-sin-directional-coupler
