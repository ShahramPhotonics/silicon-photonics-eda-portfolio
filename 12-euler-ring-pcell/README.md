...
GitHub repository: `12-euler-ring-pcell`
## Process / materials
- Technology: Low-loss SOI photonics
- Materials: Si 220 nm core, SiO2 upper cladding
- Device parameters: Ring radius 2-10 um, Euler clothoid bends, coupler gap
- Frameworks: Analytic Euler + KLayout path
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/12-euler-ring-pcell
