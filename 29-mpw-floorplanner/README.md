...
GitHub repository: `29-mpw-floorplanner`
## Process / materials
- Technology: Multi-project wafer tape-out
- Materials: 100 mm wafer / 5 mm x 5 mm dies
- Device parameters: Read many GDS, dicing streets, multiplex mask
- Frameworks: Packing + street frames
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/29-mpw-floorplanner
