...
GitHub repository: `03-pinn-waveguide-mode-solver`
## Process / materials
- Technology: SOI waveguide (220 nm height, variable width)
- Materials: Crystalline Si core on 3 um BOX SiO2
- Device parameters: Width sweep 300-1000 nm, TE/TM n_eff lookup for gdsfactory
- Frameworks: PyTorch PINN + CSV lookup + gdsfactory width mapper
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/03-pinn-waveguide-mode-solver
