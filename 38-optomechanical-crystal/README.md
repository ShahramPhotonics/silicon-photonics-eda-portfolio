...
GitHub repository: `38-optomechanical-crystal`
## Process / materials
- Technology: Cavity optomechanics
- Materials: Suspended Si membrane 220 nm, HF undercut
- Device parameters: 1D/2D nanobeam, tapered hole defect, release windows
- Frameworks: Nanobeam + etch-release
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/38-optomechanical-crystal
