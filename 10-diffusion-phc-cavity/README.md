...
GitHub repository: `10-diffusion-phc-cavity`
## Process / materials
- Technology: Photonic crystals (PhC)
- Materials: Suspended InP membrane 250 nm
- Device parameters: L3 hole displacement profiles, target resonance
- Frameworks: PyTorch DDPM + hole array GDS
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/10-diffusion-phc-cavity
