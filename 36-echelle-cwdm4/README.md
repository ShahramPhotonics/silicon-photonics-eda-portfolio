...
GitHub repository: `36-echelle-cwdm4`
## Process / materials
- Technology: Coarse WDM receiver
- Materials: SOI 220 nm or 300 nm
- Device parameters: Rowland circle, IO waveguide array, curved facets
- Frameworks: Analytic Rowland geometry
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/36-echelle-cwdm4
