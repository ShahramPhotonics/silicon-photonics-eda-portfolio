...
GitHub repository: `28-dummy-fill`
## Process / materials
- Technology: CMP and EBL load balancing
- Materials: Dummy Si tiles in cladding
- Device parameters: Density 30-50%, keep-out around waveguides
- Frameworks: Region tiling with exclusion
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/28-dummy-fill
