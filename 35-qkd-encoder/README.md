...
GitHub repository: `35-qkd-encoder`
## Process / materials
- Technology: Quantum integrated photonics
- Materials: Silica-on-silicon / thin-film LiNbO3
- Device parameters: Asymmetric MZIs, state prep, SPD interfaces, trenches
- Frameworks: QKD encoder floorplan
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/35-qkd-encoder
