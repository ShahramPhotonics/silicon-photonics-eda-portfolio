...
GitHub repository: `13-mmi-2x2-pcell`
## Process / materials
- Technology: InP photonic integrated circuits
- Materials: InGaAsP/InP MQW n=3.38
- Device parameters: W_mmi, L_mmi from beat length, parabolic tapers
- Frameworks: Self-imaging length + PCell
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/13-mmi-2x2-pcell
