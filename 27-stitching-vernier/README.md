...
GitHub repository: `27-stitching-vernier`
## Process / materials
- Technology: EBL tool calibration
- Materials: Silicon substrate with Cr/Au marks
- Device parameters: Vernier scales, interlocking grids at field edges
- Frameworks: Stitch-error metrology generator
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/27-stitching-vernier
