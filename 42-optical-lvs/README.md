...
GitHub repository: `42-optical-lvs`
## Process / materials
- Technology: Automated PIC verification
- Materials: Multi-layer waveguide and electrical layouts
- Device parameters: Port scan, path length, SPICE/INTERCONNECT netlist
- Frameworks: Connectivity tracer
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/42-optical-lvs
