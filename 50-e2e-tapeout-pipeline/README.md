...
GitHub repository: `50-e2e-tapeout-pipeline`
## Process / materials
- Technology: Complete EDA automation pipeline
- Materials: Commercial SOI silicon photonics foundry rules
- Device parameters: PCells, route, DRC, LVS, dummy fill, seal ring, OASIS zip
- Frameworks: Master orchestrator script
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/50-e2e-tapeout-pipeline
