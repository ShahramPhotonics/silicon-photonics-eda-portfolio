...
GitHub repository: `48-boolean-engine`
## Process / materials
- Technology: Layout data processing
- Materials: Arbitrary multi-layer GDSII files
- Device parameters: XOR/AND/NOT, revision detect, CLI
- Frameworks: klayout.db Region CLI
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/48-boolean-engine
