...
GitHub repository: `45-meow-tidy3d-bridge`
## Process / materials
- Technology: Open-source photonic simulation
- Materials: SiN waveguide transitions
- Device parameters: Import GDS, transmission spectra of tapers
- Frameworks: EME/FDTD API facade
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/45-meow-tidy3d-bridge
