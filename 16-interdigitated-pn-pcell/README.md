...
GitHub repository: `16-interdigitated-pn-pcell`
## Process / materials
- Technology: High-speed carrier-depletion Si modulators
- Materials: Si 220 nm, P+/P++/N+/N++ implants, silicide, contacts
- Device parameters: Finger pitch, doping overlap, metal rails
- Frameworks: Multi-layer implant PCell
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/16-interdigitated-pn-pcell
