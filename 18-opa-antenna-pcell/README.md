...
GitHub repository: `18-opa-antenna-pcell`
## Process / materials
- Technology: LiDAR OPA
- Materials: Si core 220 nm, Al top grating reflector
- Device parameters: Perturbation period, duty cycle, emission angle
- Frameworks: Grating antenna PCell
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/18-opa-antenna-pcell
