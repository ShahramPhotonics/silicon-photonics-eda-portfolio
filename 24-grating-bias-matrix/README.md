# Sub-100 nm Grating Proximity Bias Calibrator
GitHub repository: `24-grating-bias-matrix`
## Process / materials
- Technology: E-beam nanofabrication resolution tests
- Materials: Silicon nitride / HSQ resist
- Device parameters: Pitch 50-300 nm, bias -20 to +20 nm, SEM grid
- Frameworks: DOE cell array generator
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/24-grating-bias-matrix
