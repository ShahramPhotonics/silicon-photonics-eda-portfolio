...
GitHub repository: `34-ring-odl`
## Process / materials
- Technology: True time delay networks
- Materials: Low-loss Si3N4 800 nm core
- Device parameters: Double-ring loaded MZIs, heaters, bus spacing
- Frameworks: Cascaded delay generator
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/34-ring-odl
