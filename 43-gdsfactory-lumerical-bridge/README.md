# GDSFactory-to-Lumerical FDTD Simulation Bridge
GitHub repository: `43-gdsfactory-lumerical-bridge`
## Process / materials
- Technology: Photonic design automation
- Materials: Standard SOI component interfaces
- Device parameters: Export 3D, sweep, save S-params
- Frameworks: lumapi bridge with stub backend
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/43-gdsfactory-lumerical-bridge
