...
Parameters : 90-deg hybrid, balanced Ge PD, matched CPW
Stack      : Hybrid + RF lead generator
Dual-language note
------------------
...
def build_layout():
    rects = [
        (0, 0, 20, 0.5),
        (0, 8, 20, 8.5),
        (20, 0, 28, 8.5),          # 90-deg hybrid block
        (28, 1, 40, 1.8),
        (28, 6.2, 40, 7.0),
        (40, 0.5, 52, 2.4),        # Ge PD
        (40, 5.7, 52, 7.6),
...
def main():
    ...
    rects = build_layout()
    write_gds_rects(args.out, rects, cell="COH_RX")
