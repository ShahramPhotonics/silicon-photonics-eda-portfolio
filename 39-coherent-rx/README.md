# Monolithically Integrated Coherent Receiver Front-End
GitHub repository: `39-coherent-rx`
## Process / materials
- Technology: Coherent optical communications
- Materials: SOI with Ge-on-Si balanced photodiodes
- Device parameters: 90-deg hybrid, balanced Ge PD, matched CPW
- Frameworks: Hybrid + RF lead generator
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/39-coherent-rx
