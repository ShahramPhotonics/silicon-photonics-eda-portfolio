...
GitHub repository: `47-port-snapper`
## Process / materials
- Technology: Physical layout verification
- Materials: Photonic port definitions
- Device parameters: 1 nm snap tolerance, disconnected pin report
- Frameworks: Port scanner + log
## Clone and run
```bash
git clone https://github.com/ShahramPhotonics/photonics-eda-portfolio.git
cd photonics-eda-portfolio/47-port-snapper
